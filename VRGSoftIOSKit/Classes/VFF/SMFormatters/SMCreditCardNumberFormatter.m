...
#import "SMCreditCardNumberFormatter.h"

@implementation SMCreditCardNumberFormatter
...
{
    NSAssert(separatorString, @"VRGSoftIOSKit(MUCreditCardNumberFormatter): separatorString is not null!!!");
