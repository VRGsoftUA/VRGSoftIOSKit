...
- (void)sizeToFit
{
    ...
    CGFloat width = [onString sizeWithAttributes:@{NSFontAttributeName:toggleLayer.labelFont}].width;
	CGFloat offWidth = [offString sizeWithAttributes:@{NSFontAttributeName:toggleLayer.labelFont}].width;
